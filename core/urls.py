...
urlpatterns = [
    ...
    path('upload_csv/verify/', transactions.verify_transactions, name='verify_transactions'),
    path('upload_csv/verify_ajax/', transactions.verify_transactions_ajax, name='verify_transactions_ajax'),
